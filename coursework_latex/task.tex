...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 2.2. Описание функциональности приложения (use case, user story)                          & 7                  & 06.04.2026    &                     \\ \hline
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.3\textwidth} P{0.25\textwidth} @{}}
    ...
    \centering \includegraphics[height=0.8cm]{images/sig.jpg} \par \footnotesize (подпись) &
    \hfill А. А. Момина                                            \\
\end{tabularx}
}
